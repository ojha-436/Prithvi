            ...
            {LEARN_FACTS.map((f, i) => (
              <Reveal key={f.label} delay={i * 0.08}>
                <Card className="h-full p-7">
                  <p className="text-gradient tabular font-display text-4xl font-semibold">
                    {f.stat}
                  </p>
            ...
            <Reveal>
              <div>
                ...
                <p className="mt-4 max-w-md text-muted-foreground">
                  The average Indian emits about{" "}
                  <strong className="text-foreground">2.0 tonnes</strong> of CO₂ a year — roughly
                  one-seventh of an American and a quarter of a Japanese resident. The dashed line
                  marks the <strong className="text-foreground">~2.3 t</strong> per-person budget
                  the world needs to stay near 1.5°C.
                </p>
                <div
                  className="mt-8 h-72"
                  role="img"
